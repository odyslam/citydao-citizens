...
contract CitizenNFT is ERC721, Ownable, DSTest {
    ...
    /// @notice Return the number of NFTs  of a particular type that the address has locked
    /// in the Open Sea shared Storefront smart contract.
    ...
    /// @notice Mint a citizen NFT that already exists locked in the Open Sea shared Storefront smart contract.
    /// It returns the ID of the minted CityDAO NFT.
    ...
    ) public returns (uint256 refugeeId) {
        uint256 tempCitizen;
